    ...
    (function(Highcharts) {
            ...
            each(rows, function(row, i) {
                ...
                for (j = 0; j < row.length; j = j + 1) {
                    ...
                    if (typeof val === 'number') {
                        ...
                        html += '<' + tag + '>' + (val === undefined ? '0' : val) + '</' + tag + '>';
                    }
                }
       ...
       Highcharts.Chart.prototype.viewData = function() {
            if (!this.dataTableDiv && !this.insertedTable) {
                ...
                this.dataTableDiv.id = this.insertedTableID;
        ...
        /**
         * Hide the data in a table below the chart
         */
        Highcharts.Chart.prototype.hideData = function () {
            if(this.insertedTable && this.insertedTableID){
                var el= document.getElementById(this.insertedTableID);
                el.parentNode.removeChild(el);
                this.insertedTable = null;
